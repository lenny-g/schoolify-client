...
export const SignupForm = () =>{
    ...
    const ValidateForm = (formErrors) =>{
        return !!formErrors.email || !!formErrors.password || !!formErrors.title || !!formErrors.firstName || !!formErrors.lastName || !!formErrors.confirmEmail || !!formErrors.houseNumber || !!formErrors.Street || !!formErrors.city || !!formErrors.postCode || !!formErrors.phoneNumber;
    }
    ...
    <Grid item xs={12} md={6}>
        <FormControl sx={{  width: 420 }} error={!!errors.entity}>
        <InputLabel id="entity">I am a..</InputLabel>
        <Select
          labelId="entity"
          id="entity"
          value={entity}
          ...
          {...register("entity")}
        >
          <MenuItem value="mother">Parent/Guardian</MenuItem>
          <MenuItem value="father">Teacher</MenuItem>
        </Select>
      </FormControl>
