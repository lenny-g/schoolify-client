			...
			<Grid container>
				<Grid item xs={12} sx={{ display: 'flex', justifyContent: 'end' }}>
					<Box sx={item.teacherComment}>
						<Typography variant='body1'>
							Billy hurt his knee today after getting into a fight with a nother
							student. however this has been dealth with, and we can assure you
							taht this wont happen agaoin.
						</Typography>
				...
				<Grid
					...
					<Box sx={item.parentComment}>
						{' '}
						<Typography variant='body1'>thanks for letting me know</Typography>
